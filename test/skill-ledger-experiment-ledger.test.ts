    ...
    expect(ledger.experimentPortfolio).toEqual([
      {
        ...
        target:
          'When source-bound observations only is active and fewer than two admitted source-bound observations are shown, the inventory states the exact shown count and that two admitted source-bound observations are needed for source-bound comparison.',
        stopRule:
          'The in-memory notice does not fetch, collect, persist, publish instruction bodies, execute, infer another source, verify currentness or provenance, or establish security, safety, runtime behavior, adoption, suitability, ranking, recommendation, endorsement, demand, conversion, revenue, or public deployment.',
      },
      {
